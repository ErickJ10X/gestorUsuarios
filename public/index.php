                    ...
                    <div class="card main__card shadow-sm">
                        <div class="card-body main__card-body">
                            ...
                            <div class="d-flex main__actions justify-content-center gap-3 mt-4">
                                <a href="/gestorUsuarios/src/view/user/profile.php" class="btn btn-primary main__btn main__btn--profile">
                                    <i class="bi bi-person-circle"></i> Ver mi perfil
                                </a>
                                <a href="/gestorUsuarios/src/view/auth/logout.php" class="btn btn-outline-danger main__btn main__btn--logout">
                ...
                <?php else: ?>
                    ...
                    <div class="card main__card shadow-sm">
                        <div class="card-body main__card-body">
                            ...
                            <div class="d-flex main__actions justify-content-center gap-3 mt-4">
                                <a href="/gestorUsuarios/src/view/auth/login.php" class="btn btn-primary main__btn main__btn--login">
                                    <i class="bi bi-box-arrow-in-right"></i> Iniciar sesión
                                </a>
                                <a href="/gestorUsuarios/src/view/auth/register.php" class="btn btn-outline-primary main__btn main__btn--register">
